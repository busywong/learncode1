...
//        capabilities.setCapability("resetKeyboard", true);
    ...
    public void firstDemo() throws InterruptedException {
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//*[@text='本地相册']")).isDisplayed(),"顶部title与期望不符！");
    ...
    private void login() {
        ...
        driver.findElement(By.id("PassWord")).sendKeys("wnag199405017010");
    ...
    private void upload() {
        ...
        driver.findElement(By.xpath("//*[@text='确认备份']")).click();
