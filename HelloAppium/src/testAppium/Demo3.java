...
//        capabilities.setCapability("resetKeyboard", true);
    ...
    public void firstDemo() throws InterruptedException {
        ...
        //wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//RelativeLayout/ImageView[contains(@index,0)]")));

        driver.findElement(By.xpath("//android.widget.ImageView[contains(@index,0)]")).click();
     // driver.findElementByXPath("//FrameLayout")
        driver.findElement(By.id("g_slidemenu_set")).click();
       // wait.until(ExpectedConditions.presenceOfElementLocated(locator))
       // driver.findElement(By.name("注销")).click();
       // driver.findElement(By.xpath("//android.wedget.TextView[@text='注销']")).click();
    
        driver.findElementByXPath("//android.widget.TextView[@text='注 销']").click();
    ...
    private void upload() {
		//确认下本地存在Camera相册，可以改成自己的名字
    	  WebDriverWait wait = new WebDriverWait(driver, 30);
    	wait.until(ExpectedConditions.presenceOfElementLocated(By.name("163photo")));
