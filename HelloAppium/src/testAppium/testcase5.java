...
public class testcase5 {
    ...
    public void firstDemo() throws InterruptedException {
        ...
        WebDriverWait wait = new WebDriverWait(driver, 30);
         ...
         driver.findElement(By.id("photo_save_btn")).click();//download photo
         //验证图片已下载 string  成功下载到sdcard/163photo
         
         wait.until(ExpectedConditions.elementToBeClickable(By.id("photo_delete_btn")));
         driver.findElement(By.id("photo_delete_btn")).click();
         driver.findElement(By.name("确定")).click();
         //验证照片已删除
    //  WebElement  el2= driver.findElement(By.xpath("//*[contains(@text,'删除照片成功')]"));
    //  WebElement  el2= driver.findElement(By.name("删除照片成功"));
      
         //Assert.assertTrue(el2.isDisplayed(), "not found toast element");
